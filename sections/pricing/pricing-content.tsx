...
export function PricingContent() {
    const handleWhatsAppBook = (plan: string) => {
        const phone = "917780131283";
        const message = encodeURIComponent(`Hi, I'm interested in the ${plan} package. Please provide more details.`);
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 max-w-7xl mx-auto items-stretch">
                    ...
                    >
                        <div className="h-full bg-zinc-950/50 border border-white/10 rounded-3xl p-6 md:p-8 flex flex-col hover:bg-zinc-900/50 transition-colors duration-500 group shadow-[0_0_20px_rgba(0,0,0,0.5)]">
                            ...
                            <Button
                                onClick={() => handleWhatsAppBook("Hourly (The Spark)")}
                                className="w-full bg-zinc-800 hover:bg-white hover:text-black text-white font-bold tracking-wide transition-all duration-300 h-12"
                            >
                                Book Hourly
                            </Button>
                        </div>
                    ...
                    >
                        ...
                        >
                            <div className="h-full w-full p-6 md:p-8 flex flex-col relative z-20">
                                ...
                                <Button
                                    onClick={() => handleWhatsAppBook("Monthly Retainer")}
                                    className="w-full bg-red-600 hover:bg-red-500 text-white font-bold tracking-wide h-12 shadow-[0_0_20px_rgba(220,38,38,0.4)] hover:shadow-[0_0_30px_rgba(220,38,38,0.6)] transition-all duration-300 border border-red-400/20"
                                >
                                    Start Your Retainer
                                </Button>
                    ...
                    >
                        <WobbleCard containerClassName="h-full bg-zinc-950 border border-white/5 shadow-2xl group min-h-[500px]">
                            <div className="p-2 md:p-4 flex flex-col h-full relative z-10">
                                ...
                                <Button
                                    variant="outline"
                                    onClick={() => handleWhatsAppBook("Custom Quote (The Inferno)")}
                                    className="w-full border-zinc-700 hover:border-white text-white hover:bg-white hover:text-black font-bold tracking-wide transition-all duration-300 bg-transparent h-12"
                                >
